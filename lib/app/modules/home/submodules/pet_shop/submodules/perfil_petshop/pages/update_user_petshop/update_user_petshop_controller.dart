...
part 'update_user_petshop_controller.g.dart';

class UpdateUserPetshopController = _UpdateUserPetshopControllerBase
    with _$UpdateUserPetshopController;

abstract class _UpdateUserPetshopControllerBase extends Disposable with Store {
  BuildContext context;
  setContext(BuildContext contx) => this.context = contx;

  PerfilPetshopController _perfilPetshopController;
  _UpdateUserPetshopControllerBase(this._perfilPetshopController) {
  ...
  UsuarioModel get usuario => this._perfilPetshopController.usuario;
